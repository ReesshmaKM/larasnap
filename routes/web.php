...
/** MANAGER ROUTES **/
Route::group(['prefix' => 'managers', 'exculde' => ['managers.filter', 'managers.store', 'managers.update']], function(){
    Route::get('index','ManagerController@index')->name('managers.index');
    Route::post('/','ManagerController@index')->name('managers.filter');
    Route::get('create','ManagerController@create')->name('managers.create');
    Route::post('create','ManagerController@store')->name('managers.store');
    Route::get('edit/{id}','ManagerController@edit')->name('managers.edit');
    Route::put('update/{id}','ManagerController@update')->name('managers.update');
    Route::get('{user}','ManagerController@show')->name('managers.show');
    Route::delete('destroy/{id}','ManagerController@destroy')->name('managers.destroy');
});
